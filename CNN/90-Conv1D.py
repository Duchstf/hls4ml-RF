...
pruned_model = tf.keras.Sequential([
        sparsity.prune_low_magnitude(l.Conv1D(256, 10, padding='valid', activation="relu", name="conv1", kernel_initializer='glorot_uniform',input_shape=in_shp), **pruning_params),
        l.Dropout(dr),
        sparsity.prune_low_magnitude(l.Conv1D(128, 10, padding='valid', activation="relu", name="conv2", kernel_initializer='glorot_uniform'), **pruning_params),
        sparsity.prune_low_magnitude(l.Conv1D(128, 10, padding='valid', activation="relu", name="conv2", kernel_initializer='glorot_uniform'), **pruning_params),
        l.Dropout(dr),
        sparsity.prune_low_magnitude(l.Conv1D(64, 10, padding='valid', activation="relu", name="conv2", kernel_initializer='glorot_uniform'), **pruning_params),
        l.MaxPool1D(2)
        l.Flatten(),
...
print_model_to_json(pruned_model, './model/Conv1D-90.json')
    
# Save the weights
pruned_model.save_weights('./model/Conv1D-90.h5')
